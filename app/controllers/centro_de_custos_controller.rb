  ...
  def create
    ...
    respond_to do |format|
      if @centro_de_custo.save
        format.html { redirect_to @centro_de_custo, notice: 'Planilha criada com sucesso.' }
  ...
  def update
    ...
    respond_to do |format|
      if @centro_de_custo.update_attributes(params[:centro_de_custo])
        format.html { redirect_to @centro_de_custo, notice: 'Planilha atualizada com sucesso.' }
